...
In Fig. \ref{fig:07_4}, this behavior is shown in a clear way. We can see that the quenched mean field follow exactly the simulation, while the DBMF only around the epidemic treshold.

\begin{figure}[h!]
\centering
\includegraphics[width=0.7\textwidth]{../lessons/image/07/4.png}
\caption{\label{fig:07_4} The DBMF is accurate only in the proximity of the epidemic threshold while IBMF is accurate for the entire epidemic diagram.}
\end{figure}
